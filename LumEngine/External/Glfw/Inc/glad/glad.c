/*
    ...
    OpenGL loader generated by glad 0.1.36 on Tue Dec 23 07:56:23 2025.
...
PFNGLGETPROGRAMRESOURCEINDEXPROC glad_glGetProgram_ResourceIndex = NULL;
PFNGLGETPROGRAMRESOURCELOCATIONPROC glad_glGetProgram_ResourceLocation = NULL;
PFNGLGETPROGRAMRESOURCELOCATIONINDEXPROC glad_glGetProgram_ResourceLocationIndex = NULL;
PFNGLGETPROGRAMRESOURCENAMEPROC glad_glGetProgram_ResourceName = NULL;
PFNGLGETPROGRAMRESOURCEIVPROC glad_glGetProgram_Resourceiv = NULL;
...
static void load_GL_VERSION_4_3(GLADloadproc load) {
	...
	glad_glGetProgram_ResourceIndex = (PFNGLGETPROGRAMRESOURCEINDEXPROC)load("glGetProgram_ResourceIndex");
	glad_glGetProgram_ResourceName = (PFNGLGETPROGRAMRESOURCENAMEPROC)load("glGetProgram_ResourceName");
	glad_glGetProgram_Resourceiv = (PFNGLGETPROGRAMRESOURCEIVPROC)load("glGetProgram_Resourceiv");
	glad_glGetProgram_ResourceLocation = (PFNGLGETPROGRAMRESOURCELOCATIONPROC)load("glGetProgram_ResourceLocation");
	glad_glGetProgram_ResourceLocationIndex = (PFNGLGETPROGRAMRESOURCELOCATIONINDEXPROC)load("glGetProgram_ResourceLocationIndex");
