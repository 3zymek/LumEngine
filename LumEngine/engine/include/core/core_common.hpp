...
namespace settings {
	...
	inline constexpr unsigned int ECS_MAX_POOL_CAPACITY = 1000000;
	inline constexpr unsigned int ECS_MAX_ENTITY_COUNT	= 1000000;

	// Defines how much containers needs to be reserved for components
	inline constexpr unsigned int ECS_MAX_COMPONENT_TYPES_COUNT = 32;
	...
	inline constexpr unsigned int AUDIO_MAX_SOUNDS_COUNT = 1024;
	inline constexpr unsigned int AUDIO_MAX_CHANNELS_COUNT = 1024;
	...
	inline constexpr unsigned int EVENT_MAX_EVENT_TYPES = 20;

	// All settings under are for single event type

	inline constexpr unsigned int EVENT_MAX_CALLBACKS_PER_FRAME		= 10;
	inline constexpr unsigned int EVENT_MAX_PERMAMENT_CALLBACKS		= 10;
	inline constexpr unsigned int EVENT_MAX_EMITTS_PER_FRAME		= 50;
