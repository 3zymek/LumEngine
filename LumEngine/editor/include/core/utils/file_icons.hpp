...
namespace lum::editor {
	...
	inline FileIconInfo GetFileIcon( const std::filesystem::path& path, bool isDir = false ) {
        ...
        static const std::unordered_map<HashedStr, FileIconInfo> skIconsMap = {
            ...
            { HashStr( ".png" ),      { ICON_FA_IMAGE,             skFileColorTexture  }},
            { HashStr( ".jpg" ),      { ICON_FA_IMAGE,             skFileColorTexture  }},
            { HashStr( ".jpeg" ),     { ICON_FA_IMAGE,             skFileColorTexture  }},
            { HashStr( ".dds" ),      { ICON_FA_IMAGE,             skFileColorMaterial }},
            { HashStr( ".hdr" ),      { ICON_FA_SUN,               skFileColorHDR      }},
            { HashStr( ".exr" ),      { ICON_FA_SUN,               skFileColorHDR      }},
            { HashStr( ".wav" ),      { ICON_FA_MUSIC,             skFileColorAudio    }},
            { HashStr( ".mp3" ),      { ICON_FA_MUSIC,             skFileColorAudio    }},
            { HashStr( ".ogg" ),      { ICON_FA_HEADPHONES,        skFileColorAudio    }},
            { HashStr( ".json" ),     { ICON_FA_FILE_CODE,         skFileColorData     }},
            ...
            { HashStr( ".lua" ),      { ICON_FA_FILE_ALT,          skFileColorData     }},
            { HashStr( ".txt" ),      { ICON_FA_FILE_ALT,          skFileColorDefault  }},
            { HashStr( ".pdf" ),      { ICON_FA_FILE_PDF,          skFileColorError    }},
            { HashStr( ".zip" ),      { ICON_FA_FILE_ARCHIVE,      skFileColorData     }},
            { HashStr( ".mp4" ),      { ICON_FA_FILE_VIDEO,        skFileColorError    }},
